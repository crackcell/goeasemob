...
public:
     ...
     */
    EMMessageDirection msgDirection() const;
    ...
    /**
      ...
      */
    const std::vector<EMMessageBodyPtr>& bodies() const;
    ...
    /**
      ...
      */
    template<typename T>
    bool getAttribute(const std::string &attribute, T &value) const;
    ...
    /**
      ...
      */
    const std::map<std::string, std::shared_ptr<EMAttributeValue> > & ext() const;
...
public:
    ...
    /**
      ...
      */
    static std::shared_ptr<EMMessage> createReceiveMessage(const std::string &from, const std::string &to, const EMMessageBodyPtr &body, EMChatType = SINGLE);
